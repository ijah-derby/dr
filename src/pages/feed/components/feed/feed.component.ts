...
const browser: ThemeableBrowserObject = this.themeableBrowser.create('https://dontramp.com/hq/businesses', '_self', options);
...
const browser: ThemeableBrowserObject = this.themeableBrowser.create('https://dontramp.com/hq/knowledge', '_self', options);
