...
/* harmony import */ var src_shared_services_common_common_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/shared/services/common/common.service */ "./src/shared/services/common/common.service.ts");
...
var ImageService = /** @class */ (function () {
    function ImageService(angularfire, loadingProvider, camera, mediaCapture, firestore, commonService, file) {
    ...
    ImageService.prototype.uploadGroupVideoMessage = function (groupId) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.commonService.getVideo().then(function (url) {
                var videoUrl = url;
                videoUrl = _this.commonService.videoBase64;
                _this.firestore.uploadVideoString(videoUrl, 'DontRamp_chat_' + new Date().getTime()).then(function (url) {
                    _this.loadingProvider.dismissLoader();
                    resolve(url);
                }, function (err) {
                    _this.loadingProvider.dismissLoader();
    ...
    ImageService.prototype.uploadVideoMessage = function (conversationId) {
        ...
        return new Promise(function (resolve, reject) {
            _this.loadingProvider.presentProcessingLoading();
            _this.commonService.getVideo().then(function (url) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                var videoUrl;
                var _this = this;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.loadingProvider.displayProgress()];
                        case 2:
                            _a.sent();
                            this.firestore.uploadVideoString(videoUrl, 'DontRamp_chat_' + new Date().getTime()).then(function (url) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.loadingProvider.dismissLoader()];
                                        case 1:
                                            _a.sent();
    ...
    ImageService.ctorParameters = function () { return [
        ...
        { type: src_shared_services_common_common_service__WEBPACK_IMPORTED_MODULE_9__["CommonService"] },
    ...
    ImageService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_database__WEBPACK_IMPORTED_MODULE_3__["AngularFireDatabase"],
            ...
            src_shared_services_common_common_service__WEBPACK_IMPORTED_MODULE_9__["CommonService"],
